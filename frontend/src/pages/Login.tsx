    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="flex min-h-screen items-center justify-center pt-20 p-4">
                {/* same as register page but it's tuff*/}
                <div
                ...
                >
                    <div className="w-full max-w-xs space-y-6">
                        <h2 className="text-3xl font-serif font-bold text-center text-[#DFE6E6] mb-8 tracking-wider drop-shadow-md">
                            Login
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    type="text"
                                    required
                                    className="w-full px-4 py-3 bg-[#DFE6E6]/10 border border-[#DFE6E6]/20 rounded-lg text-[#DFE6E6] placeholder-[#DFE6E6]/40 focus:outline-none focus:ring-2 focus:ring-[#DFE6E6]/50 focus:border-transparent transition-all backdrop-blur-sm"
                        ...
                        <p className="mt-6 text-center text-sm text-[#DFE6E6]/60">
                            Don't have an account?{' '}
                            <Link to="/register" className="text-[#DFE6E6] hover:text-white font-semibold hover:underline decoration-2 underline-offset-4 transition-colors">
                                Register here
                            </Link>
                        </p>
                    </div>
